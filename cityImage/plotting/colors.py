...
def random_colors_list(nlabels, vmin=0.8, vmax=1.0, hsv=False):
    ...
    randHSVcolors = [
        (
            np.random.uniform(low=0.0, high=0.95),
            np.random.uniform(low=0.4, high=0.95),
            np.random.uniform(low=vmin, high=vmax),
        )
...
def rand_cmap(nlabels, type_color="soft"):
    ...
    if type_color == "bright":
        randHSVcolors = [
            (
                np.random.uniform(low=0.0, high=0.8),
...
def kindlmann():
    ...
    kindlmann_list = [
        (0.00, 0.00, 0.00, 1),
        (0.248, 0.0271, 0.569, 1),
        (0.0311, 0.258, 0.646, 1),
        (0.019, 0.415, 0.415, 1),
        (0.025, 0.538, 0.269, 1),
        (0.0315, 0.658, 0.103, 1),
        (0.331, 0.761, 0.036, 1),
        (0.768, 0.809, 0.039, 1),
        (0.989, 0.862, 0.772, 1),
        (1.0, 1.0, 1.0),
